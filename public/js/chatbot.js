...
(function () {
	...
	widgetStyles.textContent = `
        .chat-assist-widget {
            --chat-color-primary: var(--chat-widget-primary, #ff6900);
            --chat-color-secondary: var(--chat-widget-secondary, #D4854E);
            --chat-color-tertiary: var(--chat-widget-tertiary, #D4854E);
            --chat-color-light: var(--chat-widget-light, #fed8b1);
            --chat-color-surface: var(--chat-widget-surface, #ffffff);
            --chat-color-text: var(--chat-widget-text, #1f2937);
            --chat-color-text-light: var(--chat-widget-text-light, #6b7280);
            --chat-color-border: var(--chat-widget-border, #e5e7eb);
            --chat-shadow-sm: 0 1px 3px rgba(255, 105, 0, 0.1);
            --chat-shadow-md: 0 4px 6px rgba(212, 133, 78, 0.15);
            --chat-shadow-lg: 0 10px 15px rgba(255, 105, 0, 0.2);
            --chat-radius-sm: 8px;
            --chat-radius-md: 12px;
            --chat-radius-lg: 20px;
        ...
        .chat-assist-widget .chat-launcher svg, .chat-assist-widget .chat-launcher img {
            width: 24px;
            height: 24px;
        }
	...
	const defaultSettings = {
		...
		branding: {
			...
			responseTimeText: '',
			poweredBy: {
				text: 'Powered by Click2Buy AI',
				link: 'https://www.creatoaiagency.com',
			},
		},
		style: {
			primaryColor: '#ff6900', // Light Orange
			secondaryColor: '#D4854E', // Orange
			position: 'right',
	...
	const settings = window.ChatWidgetConfig
		? {
				...
				style: {
					...
					// Force orange colors if user provided purple
					primaryColor:
						window.ChatWidgetConfig.style?.primaryColor === '#854fff'
							? '#ff6900'
							: window.ChatWidgetConfig.style?.primaryColor || '#ff6900',
					secondaryColor:
						window.ChatWidgetConfig.style?.secondaryColor === '#6b3fd4'
							? '#D4854E'
							: window.ChatWidgetConfig.style?.secondaryColor || '#D4854E',
				},
				suggestedQuestions:
					window.ChatWidgetConfig.suggestedQuestions || defaultSettings.suggestedQuestions,
			}
		: defaultSettings;
        ...
        <div class="user-registration">
            ...
            <form class="registration-form">
                <div class="form-field">
                    <label class="form-label" for="chat-user-name">Full Name</label>
                    <input type="text" id="chat-user-name" class="form-input" placeholder="Your full name" required>
                ...
                <button type="submit" class="submit-registration">Start Conversation</button>
            </form>
        </div>
    `;
	...
	const chatInterfaceHTML = `
        <div class="chat-body">
            ...
            <div class="chat-controls">
                <textarea class="chat-textarea" placeholder="Your message..." rows="1"></textarea>
	...
	launchButton.innerHTML = `
        <img src="/logo.svg" alt="Chat Icon">
	...
	async function handleRegistration(event) {
		...
		try {
			...
			errorMessage.textContent = "I'm having connection issues. Please try again later.";
	...
	function autoResizeTextarea() {
		...
		messageTextarea.style.height =
			(messageTextarea.scrollHeight > 120 ? 120 : messageTextarea.scrollHeight) + 'px';
	}
